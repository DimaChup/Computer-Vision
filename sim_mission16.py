...
class VisualFlightMission:
    ...
    def select_target_on_map(self):
        ...
        print("CLICK map to place target.")
        print(" [Left Click]: Red Dot (15cm)")
        print(" [Right Click / Ctrl+Click]: Stickman Dummy (1.8m)")
        print("Press KEY to start mission.")
        cv2.waitKey(0)
        cv2.destroyWindow("Select Target")
        
        if hasattr(self, 'sim_target_px'):
            self.sim_target_type = self.temp_type
            # We don't burn it into self.full_map here. We render dynamically.
    ...
    def run(self):
        ...
        while True:
            ...
            if self.state == State.INIT:
                ...
                # Add 'i' and 'k' as robust alternatives for altitude
