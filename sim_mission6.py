...
class VisualFlightMission:
    ...
    def select_target_on_map(self):
        ...
        def mouse_callback(event, x, y, flags, param):
            if event == cv2.EVENT_LBUTTONDOWN:
                ...
                # Draw using the calculated radius
                cv2.circle(temp_vis, (x, y), self.target_radius_px, (0, 0, 255), -1)
    ...
    def update_dashboard(self):
        ...
        # 1. Draw Crosshair on Drone View
        ...
        cv2.putText(drone_frame, f"Drone: {self.lat:.6f}, {self.lon:.6f}", (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 255), 2)
        cv2.putText(drone_frame, f"Alt: {self.alt:.1f}m", (10, 90), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 255), 2)
