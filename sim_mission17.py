...
# UPDATED: Native Resolution of Raspberry Pi Global Shutter Camera
...
class VisualFlightMission:
    ...
    def update_dashboard(self):
        ...
        # SCALE FOR DISPLAY
        # Force the display window to fit within standard laptop screen width (e.g., 1280px)
        ...
        cv2.imshow("Mission Dashboard", display_img)
        return found, u, v
